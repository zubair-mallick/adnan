...
export default function App() {
  ...
  const [enabledMethods, setEnabledMethods] = useState({
    systemBiometric: true,   // Always enabled initially
    customPin: false,
      ...
      case 'lock':
        return (
          <View style={styles.screenContainer}>
            ...
            <Text style={styles.subtitle}>Unlock with system authentication first</Text>
            
            <TouchableOpacity onPress={performSystemAuth} style={styles.button}>
              <Text style={styles.buttonTitle}>🔓 Unlock System</Text>
              <Text style={styles.buttonSubtitle}>Use {biometricType} or Device PIN</Text>
            </TouchableOpacity>
          </View>
        );
        ...
        return (
          <ScrollView style={styles.container}>
            <View style={styles.screenContainer}>
              ...
              {/* System Biometric - Always Enabled */}
